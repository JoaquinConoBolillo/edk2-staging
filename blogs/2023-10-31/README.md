...
## Abstract
This article discusses a fundamental construction flaw in the 
the calibration of the TSC Time Stamp Counter on all x86 platforms 
that prevents UEFI from using the TSC as a wall clock.
